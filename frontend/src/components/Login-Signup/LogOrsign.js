                                ...
                                <div className="form-input">
                                    ...
                                    <form onSubmit={(e) => { submitData(e) }}>
                                        ...
                                        <div class="myform-button">
                                            <button type="submit" className="myform-btnu">Login as user</button>
                                            
                                            <button type="submit" className="myform-btna">Login as admin</button>
                                            
                                        </div>
                                        
                                        <div>
                                        
                                            <small className="form-text text-muted signup-text">Don't have an Account?(Users Only) : 
                                            </small>
